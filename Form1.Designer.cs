...
namespace pixellab
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.flowSidebar.FlowDirection =
            ...
            this.flowSidebar.Padding =
                new Padding(15);

            this.flowSidebar.BackColor =
                Color.FromArgb(24, 24, 24);
            ...
            this.panelInspector.Dock =
                DockStyle.Right;

            this.panelInspector.Width = 300;

            this.panelInspector.BackColor =
                Color.FromArgb(24, 24, 24);

            this.panelInspector.Padding =
                new Padding(15);
            ...
            this.panelImageContainer.Dock =
                DockStyle.Fill;

            this.panelImageContainer.Padding =
                new Padding(10);

            this.panelImageContainer.BackColor =
                Color.FromArgb(18, 18, 18);
            ...
            this.pictureBox1.MouseClick +=
                new MouseEventHandler(this.pictureBox1_MouseClick);
